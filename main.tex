...
\usepackage{booktabs}
%\usepackage{tocloft}
% Ajuster les numéros de  page de section avec les numéros de pages de chapitres dans la table des matières
%\renewcommand{\cftchappagefont}{\fontfamily{Latin Modern Roman}\fontseries{b}\selectfont} 
