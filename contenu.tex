...
\begin{quotation}
  \ttfamily\RaggedRight
  \noindent{}Date : 8 trisuel 28931 \emph{ab Arca jactata}%\footnote{Correspondant au huitième jour, du troisième mois, de l’année 28871 après le lancement de l’Arche.}
  \\
  De : L’Informateur\\
...
\begin{drama}
  ...
  \elenaspeaks \direct{Éxaminant entre ses doigts la dame des figurines de Lewis} Et moi, je gage, précepteur, qu’il viendra tout au contraire me présenter une vive reconnaissance.
...
\begin{drama}
  ...
  \roispeaks Approche-toi, \general, tu es mon seul ami dans ce monde, \direct{\general{} s’approche au-delà du seuil protégé des gardes} toi qui as bien voulu périr à la place de ma fille, troquer ta vie contre la sienne, je te nomme commodore de toutes nos armées.  \direct{Regardant vers le corps de \princesse{}} N’est-ce pas \princesse ? Ne trouves-tu pas notre édit bien inspiré ? \direct{À \general} Va et trouve-moi ceux qui accompagneront ma fille vers l’autre monde, non, non, qui l’y \autonym{précéderont}. Et en paveront le sentier qui sera usé par de nombreux pieds avant que \princesse n’ait à l’emprunter.
...
\begin{drama}
  ...
  \alexasspeaks Mais ils finirent par tomber en disgrâce, et leur déchéance leur emporta la vie. L’Alhambra, soit la \xenism{rouge} dans la langue de la Vieille-Terre, ne porta jamais aussi bien son nom que lorsque de ses fontaines jaillit le sang des Abencérages, tant on en occit en une seule journée.
...
\decors{Dans la salle du trône où \roi toujours aussi inconsolable tient encore le corps sans vie de \princesse qui se putréfie. Des chaudrons d’où émane une fumée odorante censée camoufler la puanteur sont disposés dans la pièce.}
...
\begin{drama}
  ...
  \direct{En se levant de son lit et courant embrasser \ela.} Ma fille adorée, bénie soit l’immensité du Cosmos. Te voilà de nouveau à moi. Je te veux montrer aux parlementaires et aux seigneurs qui doutent de ta vigueur. Je voudrais te lancer de nouveau contre nos ennemis, que tu venges notre précédente déconvenue. Et que ta gloire soit totale.
...
\begin{drama}
  ...
  \speaker{Un garde} Mon roi, \general demande à entrer dans la salle du trône.
  ...
  \roispeaks Voilà un compost bien à même de fertiliser le terreau de nos futures agapes.
\end{drama}
...
\begin{drama}
  ...
  \elaspeaks Bien. Je m’y emploierai. Dîtes, \autonym{mon frère} puisque c’est ainsi que je dois désormais vous considérer, vous m’entretîntes la fois dernière de ces Abassides.
  ...
  \elaspeaks \direct{Interrompant \elena} Je sais ce qu’est une île.
...
\decors{Dans la cour de justice, entrent \roi{} suivi de \reine{} et des nobles du conseil qui sont assesseurs.}
...
%     \hfill\textarabic{أَثَّرَتْ فِينا عُيونُ النَّرْجِسِ؟}
   ...
   \elenaspeaks Ha, la boutade ! %N’ayant pas d’inclination incestueuse, je ne vous veux point pour amante ni partenaire, soyez-en rassurée.
   Néanmoins,
...
\decors{Dans la salle du trône, entrent \reine et \vladimir}
...
\begin{drama}
  ...
  \vladimirspeaks Que cela signifie-t-il ? Lâchez-moi. \direct{Se tournant vers sa mère} Mère, mère, dites-leur quelque chose. Lachez-moi, je suis l’héritier.


  \reinespeaks \direct{Tentant de libérer son fils des gardes} Lâchez-le manants, qui vous autorise à le saisir ? \direct{Vers le roi} Sire, ordonez-leur de le libérer, de libérer notre fils.
  ...
  \reinespeaks \direct{Frappant du poing sur les armories} \elena, \elena, je te maudis \elena. Puisse-tu avoir toi aussi des enfants, de forts nombreux et prolifiques, qu’afin que tu leur survives à tous, et que de ton vivant tu assistes impotent à leur trépas. \elena Skylab, bâtard, si tu es né de femme par voie naturelle, que ta mort, elle, soit artificielle. \elena, \elena. Je briserai le linteau de ton hui. Putride \elena. \elena, \elena \direct{Elle crie son nom de dégout jusqu’à en devenir aphone.}.
...
%\StageDirII{\roi, \ela}
%
%\decors{Dans la salle du trône, \roi enlace \ela allongés sur le lit trônal.}
%
...
\begin{quotation}
  \ttfamily\RaggedRight
  \noindent{}Date : 15 trisuel 29931 \emph{ab Arca jactata}\footnote{Correspondant au quinzième jour, du troisième mois, de l’année 28871 après le lancement de l’Arche.}\\
  De : L’Informateur\\
  À : État-major du royaume de \campoppose{}\\
  Objet : Plan d’attaque du \campprincipal{}\\
...
\begin{quotation}
  \ttfamily\RaggedRight
  \noindent{}Date : 15 trisuel 29931 \emph{ab Arca jactata}\\
...
\begin{drama}
  ...
  \elaspeaks Il n’y a plus de front, père, votre \elena tout paré de gloires qu’elles lui alourdissent les épaules a repoussé le front jusqu’aux parois extérieures de l’Arche. Et nos forces sont désormais des troupes d’occupations. \direct{Elle prend son diadème de la tête et le lui jette aux pieds} tenez, lorsque vous le ferez assoir sur votre trône parez-le de ma couronne, et délestez-moi de la vie qui désormais me sera insoutenable devant mon bâtard de sujet qui a fait plus en une journée pour le royaume et l’Arche entière que je n’en ferais de toute ma vie.
  ...
  \StageDir{Désemparé, \roi perçoit la fiole laissée par \ela, il la saisit, la boit, et meurt.}
\end{drama}
...
\begin{drama}
  ...
  \reinespeaks Cet effet aussi vous le préparâtes de longue date ? Est-ce là une façon littérale de me dire que vous me faites une fleur ? %\workingnote{Préciser que le pot ne contient qu’une seule fleur.}
  \elenaspeaks Si ça en était une ça devrait être une arnica ou une belladone, tant elle est \incise{tant elle fut} vénéneuse et épineuse. N’ayant trouvé d’autre pot où la planter que ce drakkar, j’ai cru y voir l’embarcation la mieux à même de l’accompagner au Valhalla.
